<?php
	...
	$xml = xml_cartao($_POST['idcart'], $produtos, $valor, $_POST['nome'],$_POST['sobrenome'], $_POST['cpf'], $_POST['ddd'], $_POST['telefone'], $_POST['email'], $_POST['senderHash'], $_POST['endereco'], $_POST['numero'], $_POST['complemento'], $_POST['bairro'], $_POST['cep'], $_POST['cidade'], $_POST['estado'], $_POST['enderecoPagamento'], $_POST['numeroPagamento'], $_POST['complementoPagamento'], $_POST['bairroPagamento'], $_POST['cepPagamento'], $_POST['cidadePagamento'], $_POST['estadoPagamento'], $_POST['cardToken'], $_POST['cardNome'], $_POST['cardCPF'], $nasc, $_POST['cardFoneArea'], $_POST['cardFoneNum'], $_POST['numParcelas'], $_POST['valorParcelas']);
