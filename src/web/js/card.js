var card = function (r) {
    ...
    function t(a) {
        ...
        return r[a].call(n.exports, n, n.exports, t),
            n.l = !0,
            n.exports
    }
    return t.m = r,
                ...
                e.on = function (r, t, a) {
                    ...
                    if (r.length)
                        ...
                        if (!t.match(" "))
                            return l = a,
                                a = function (r) {
                                    return r = e.normalizeEvent(r),
                                        l(r)
                                }
                                ,
                                r.addEventListener ? r.addEventListener(t, a, !1) : r.attachEvent ? (t = "on" + t,
                                    r.attachEvent(t, a)) : void (r["on" + t] = a);
                        for (i = 0,
                            c = (s = t.split(" ")).length; i < c; i++)
                            p = s[i],
                                e.on(r, p, a)
                    }
                }
                    ...
                    if (r.length)
                        return function () {
                            ...
                            for (i = [],
                                ...
                                o = r.length; a < o; a++)
                                n = r[a],
                                    i.push(e.removeClass(n, t));
                            return i
                        }();
                    if (r.classList) {
                        for (c = [],
                            o = 0,
                            i = (d = t.split(" ")).length; o < i; o++)
                            a = d[o],
                                c.push(r.classList.remove(a));
                        return c
                    }
                ...
                a = function () {
                    ...
                    function e(r) {
                        ...
                        this.maskCardNumber = (e = this.maskCardNumber,
                            ...
                            this.options.form ? (this.$el = n(this.options.form),
                                this.options.container ? (this.$container = n(this.options.container),
                                    (a = n.isDOMElement(this.$container) ? this.$container : this.$container[0]).getAttribute(this.initializedDataAttr) || (a.setAttribute(this.initializedDataAttr, !0),
                                        this.render(),
                                        this.attachHandlers(),
                    ...
                    return e.prototype.initializedDataAttr = "data-jp-card-initialized",
                        ...
                        ,
                        e.prototype.cardTypes = ["jp-card-amex", "jp-card-dankort", "jp-card-dinersclub", "jp-card-discover", "jp-card-unionpay", "jp-card-jcb", "jp-card-laser", "jp-card-maestro", "jp-card-mastercard", "jp-card-troy", "jp-card-unionpay", "jp-card-visa", "jp-card-visaelectron", "jp-card-elo", "jp-card-hipercard"],
                        ...
                        e.prototype.render = function () {
                            var r, e, t, a, i, d, c, p;
                            for (t in n.append(this.$container, this.template(this.cardTemplate, o({}, this.options.messages, this.options.placeholders))),
                                i = this.options.cardSelectors)
                                c = i[t],
                                    this["$" + t] = n.find(this.$container, c);
                            for (t in d = this.options.formSelectors)
                                c = d[t],
                                    c = this.options[t] ? this.options[t] : c,
                                    !(a = n.find(this.$el, c)).length && this.options.debug && console.error("Card can't find a " + t + " in your form."),
                                    this["$" + t] = a;
                            if (this.options.formatting && (Payment.formatCardNumber(this.$numberInput),
                                Payment.formatCardCVC(this.$cvcInput),
                                Payment.formatCardExpiry(this.$expiryInput)),
                                this.options.width && (r = n(this.options.cardSelectors.cardContainer)[0],
                                    e = parseInt(r.clientWidth || window.getComputedStyle(r).width),
                                    r.style.transform = "scale(" + this.options.width / e + ")"),
                                ("undefined" != typeof navigator && null !== navigator ? navigator.userAgent : void 0) && -1 !== (p = navigator.userAgent.toLowerCase()).indexOf("safari") && -1 === p.indexOf("chrome") && n.addClass(this.$card, "jp-card-safari"),
                        ...
                        e.prototype.attachHandlers = function () {
                            var e, t;
                            return t = [this.validToggler("cardNumber")],
                        ...
                        e.prototype.handle = function (r) {
                            return e = this,
                                function (t) {
                                    var a;
                                    return (a = Array.prototype.slice.call(arguments)).unshift(t.target),
                        ...
                        e.prototype.validToggler = function (r) {
                            ...
                            return "cardExpiry" === r ? e = function (r) {
                                var e;
                                return e = Payment.fns.cardExpiryVal(r),
                        ...
                        e.prototype.toggleValidClass = function (r, e) {
                            return n.toggleClass(r, this.options.classes.valid, e),
                                n.toggleClass(r, this.options.classes.invalid, !e)
                        }
                        ,
                        e.prototype.maskCardNumber = function (r, e, t) {
                            var a, n;
                            return a = this.options.masks.cardNumber,
                                (n = r.split(" ")).length >= 3 ? (n.forEach((function (r, e) {
                                    if (e !== n.length - 1)
                        ...
                        e.prototype.handlers = {
                            setCardType: function (r, e) {
                                ...
                                if (t = e.data,
                                    ...
                                    return n.removeClass(this.$card, "jp-card-unknown"),
                        ...
                        r = function (r, e, t) {
                            ...
                            return null == t && (t = {}),
                                ...
                                t.join = t.join || "",
                                "function" != typeof t.join && (a = t.join,
                                    t.join = function () {
                                        return a
                                    }
                                ),
                                ...
                                n.on(r, "keyup change paste", (function (a) {
                                    ...
                                    for (b = [],
                                        ...
                                        f = e.length; l < f; d = ++l)
                                        g = e[d],
                                            u = t.fill ? h + i[d].substring(h.length) : h || i[d],
                                            b.push(g.textContent = u);
                                    return b
                                }
                                )),
                                r
            ...
            return r.toString = function () {
                ...
                r.i = function (e, t) {
                    ...
                    for (n = 0; n < e.length; n++) {
                        var i = e[n];
                        "number" == typeof i[0] && a[i[0]] || (t && !i[2] ? i[2] = t : t && (i[2] = "(" + i[2] + ") and (" + t + ")"),
                            r.push(i))
                    }
                }
                ,
    ...
    , function (r, e) {
        var t = {}
            , a = function (r) {
                var e;
                return function () {
                    return void 0 === e && (e = r.apply(this, arguments)),
                        e
                }
            }
            , n = a((function () {
        ...
        function u(r, e) {
            ...
            if (e.singleton) {
                ...
                r.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (t = function (r) {
                ...
                n = t(1),
                    ...
                    o = function (r) {
                        ...
                        for (r = (r + "").replace(/\D/g, ""),
                            ...
                            n = d.length; a < n; a++)
                            e = d[a],
                                (o = r.match(e.pattern)) && (!t || o[0].length > t[1][0].length) && (t = [e, o]);
                        return t && t[0]
                    }
                    ,
                    i = function (r) {
                    ...
                    h = function (r) {
                        ...
                        for (o = !0,
                            i = 0,
                            a = 0,
                            n = (t = (r + "").split("").reverse()).length; a < n; a++)
                            e = t[a],
                                e = parseInt(e, 10),
                                (o = !o) && (e *= 2),
                                e > 9 && (e -= 9),
                    ...
                    b = function (r) {
                        ...
                        try {
                            if (null != r.selectionStart && r.selectionStart !== r.selectionEnd)
                                return !0;
                            if (null != ("undefined" != typeof document && null !== document && null != (t = document.selection) ? t.createRange : void 0) && document.selection.createRange().text)
                                return !0
                        } catch (e) {
                            e
                        }
                        ...
                        return function (e) {
                            ...
                            if (a = String.fromCharCode(e.which),
                                ...
                                for (l = e.target,
                                    ...
                                    f = [16],
                                    t && (f = t.length),
                                    r && (f = f.filter((function (e) {
                                        return e <= r
                                    }
                                    ))),
                                    i = d = 0,
                                    c = f.length; d < c; i = ++d)
                                    if (!(p >= (s = f[i]) && f[i + 1]) && p >= s)
                                        return;
                                if (!b(l))
                                    return (t && "amex" === t.type ? /^(\d{4}|\d{4}\s\d{6})$/ : /(?:^|\s)(\d{4})$/).test(g) ? (e.preventDefault(),
                                        n.val(l, g + " " + a),
                                        n.trigger(l, "change")) : void 0
                            }
                        }
                    }
                    ,
                    p = function (r) {
                        ...
                        if (e = r.target,
                            t = n.val(e),
                            !r.meta && 8 === r.which && !b(e))
                            return /\d\s$/.test(t) ? (r.preventDefault(),
                                n.val(e, t.replace(/\d\s$/, "")),
                                n.trigger(e, "change")) : /\s\d?$/.test(t) ? (r.preventDefault(),
                                    n.val(e, t.replace(/\s\d?$/, "")),
                                    n.trigger(e, "change")) : void 0
                    }
                    ,
                    f = function (r) {
                        var e, t, a;
                        if (e = String.fromCharCode(r.which),
                            /^\d+$/.test(e))
                            return t = r.target,
                                a = n.val(t) + e,
                                /^\d$/.test(a) && "0" !== a && "1" !== a ? (r.preventDefault(),
                                    n.val(t, "0" + a + " / "),
                                    n.trigger(t, "change")) : /^\d\d$/.test(a) ? (r.preventDefault(),
                                        n.val(t, a + " / "),
                                        n.trigger(t, "change")) : void 0
                    }
                    ,
                    j = function (r) {
                        var e, t, a;
                    ...
                    u = function (r) {
                        ...
                        if ("/" === String.fromCharCode(r.which))
                            return e = r.target,
                                t = n.val(e),
                                /^\d$/.test(t) && "0" !== t ? (n.val(e, "0" + t + " / "),
                                    n.trigger(e, "change")) : void 0
                    }
                    ,
                    l = function (r) {
                        var e, t;
                        if (!r.metaKey && (e = r.target,
                            t = n.val(e),
                            8 === r.which && !b(e)))
                            return /\d(\s|\/)+$/.test(t) ? (r.preventDefault(),
                                n.val(e, t.replace(/\d(\s|\/)*$/, "")),
                                n.trigger(e, "change")) : /\s\/\s?\d?$/.test(t) ? (r.preventDefault(),
                    ...
                    C = function (r) {
                        var e;
                        return !(!r.metaKey && !r.ctrlKey) || (32 === r.which ? r.preventDefault() : 0 === r.which || (r.which < 33 || (e = String.fromCharCode(r.which),
                    ...
                    x = function (r) {
                        return function (e) {
                            ...
                            if (d = e.target,
                                ...
                                /^\d+$/.test(a) && !b(d))
                                return c = (n.val(d) + a).replace(/\D/g, ""),
                                    i = 16,
                    ...
                    a = function () {
                        ...
                        return r.fns = {
                            cardExpiryVal: function (r) {
                                var e, t, a;
                                return e = (t = (r = r.replace(/\s/g, "")).split("/", 2))[0],
                            ...
                            validateCardNumber: function (r) {
                                ...
                                return r = (r + "").replace(/\s+|-/g, ""),
                                    !!/^\d+$/.test(r) && (!!(e = o(r)) && (t = r.length,
                                        $.call(e.length, t) >= 0 && (!1 === e.luhn || h(r))))
                            },
                            validateCardExpiry: function (e, t) {
                                var a, o, i, d;
                                return "object" == typeof e && "month" in e ? (e = (i = e).month,
                                    t = i.year) : "string" == typeof e && $.call(e, "/") >= 0 && (e = (d = r.fns.cardExpiryVal(e)).month,
                                        t = d.year),
                                    !(!e || !t) && (e = n.trim(e),
                                        t = n.trim(t),
                                        !!/^\d+$/.test(e) && (!!/^\d+$/.test(t) && (!!((e = parseInt(e, 10)) && e <= 12) && (2 === t.length && (t = (new Date).getFullYear().toString().slice(0, 2) + t),
                                            o = new Date(t, e),
                                            a = new Date,
                            ...
                            validateCardCVC: function (r, e) {
                                var t, a;
                                return r = n.trim(r),
                                    !!/^\d+$/.test(r) && (e && i(e) ? (t = r.length,
                                        $.call(null != (a = i(e)) ? a.cvcLength : void 0, t) >= 0) : r.length >= 3 && r.length <= 4)
                            },
                            cardType: function (r) {
                                var e;
                            ...
                            formatCardNumber: function (r) {
                                var e, t, a, n;
                                return (e = o(r)) ? (n = e.length[e.length.length - 1],
                                    r = (r = r.replace(/\D/g, "")).slice(0, n),
                                    e.format.global ? null != (a = r.match(e.format)) ? a.join(" ") : void 0 : null != (t = e.format.exec(r)) ? (t.shift(),
                            ...
                            r.formatCardExpiry = function (e) {
                                var t, a;
                                return r.restrictNumeric(e),
                                    e.length && 2 === e.length ? (t = e[0],
                                        a = e[1],
                                        this.formatCardExpiryMultiple(t, a)) : (n.on(e, "keypress", y),
                                            n.on(e, "keypress", f),
                                            n.on(e, "keypress", u),
                                            n.on(e, "keypress", g),
                                            n.on(e, "keydown", l)),
     ...
     */
        ...
        function p() {
            var r, e, t, n, o, i, l = arguments[0] || {}, s = 1, f = arguments.length, g = !1;
            for ("boolean" == typeof l && (g = l,
                l = arguments[1] || {},
                s = 2),
                "object" == typeof l || a.fn(l) || (l = {}); s < f; s++)
                if (null != (r = arguments[s]))
                    for (e in "string" == typeof r && (r = r.split("")),
                        r)
                        t = c(l, e),
                            l !== (n = c(r, e)) && (g && n && (a.hash(n) || (o = a.array(n))) ? (o ? (o = !1,
                                i = t && a.array(t) ? t : []) : i = t && a.hash(t) ? t : {},
                                d(l, e, p(g, i, n))) : void 0 !== n && d(l, e, n));
            return l
        }
        p.version = "1.1.7",
            r.exports = p
     ...
     */
        ...
        f.a = f.type = function (r, e) {
            ...
            f.empty = function (r) {
                var e, t = d.call(r);
                if ("[object Array]" === t || "[object Arguments]" === t || "[object String]" === t)
                    return 0 === r.length;
                if ("[object Object]" === t) {
                    for (e in r)
                        if (i.call(r, e))
            ...
            f.equal = function (r, e) {
                ...
                if ("[object Object]" === a) {
                    for (t in r)
                        if (!f.equal(r[t], e[t]) || !(t in e))
                            return !1;
                    for (t in e)
                        if (!f.equal(r[t], e[t]) || !(t in r))
                            return !1;
                    return !0
                }
                if ("[object Array]" === a) {
    ...
    , function (r, e, t) {
        ...
        r.exports = function (r) {
            ...
            for (var t, i = n.call(arguments, 1), d = function () {
                ...
                p.push("$" + l);
            if (t = Function("binder", "return function (" + p.join(",") + "){ return binder.apply(this,arguments); }")(d),
                e.prototype) {
                var s = function () { };
